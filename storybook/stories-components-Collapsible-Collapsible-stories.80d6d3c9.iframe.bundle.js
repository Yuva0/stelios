/*! For license information please see stories-components-Collapsible-Collapsible-stories.80d6d3c9.iframe.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunkstelios=self.webpackChunkstelios||[]).push([[6243],{"./src/stories/components/Collapsible/Collapsible.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Contained:()=>Contained,Outlined:()=>Outlined,Soft:()=>Soft,Transparent:()=>Transparent,__namedExportsOrder:()=>__namedExportsOrder,default:()=>Collapsible_stories});var react=__webpack_require__("./node_modules/react/index.js"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),ThemeProvider=__webpack_require__("./src/components/ThemeProvider/ThemeProvider.tsx"),helpers=__webpack_require__("./src/helpers/helpers.tsx"),colors=__webpack_require__("./src/tokens/colors.json"),Text=__webpack_require__("./src/components/Text/Text.tsx"),IconChevronUp=__webpack_require__("./node_modules/@tabler/icons-react/dist/esm/icons/IconChevronUp.mjs"),IconChevronDown=__webpack_require__("./node_modules/@tabler/icons-react/dist/esm/icons/IconChevronDown.mjs"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const Collapsible=_ref=>{let{variant="contained",title,children,open=!1,color=colors.A.zB.iW,width="auto",style,className,onToggle,"data-testid":dataTestId,"data-testid-title":dataTestIdTitle,...props}=_ref;const theme=(0,ThemeProvider.DP)().theme,colorPalette=(0,helpers.jh)(theme,color),[_isOpen,setIsOpen]=react.useState(open),_ChildrenEle="string"==typeof children?(0,jsx_runtime.jsx)(StyledChildren,{$variant:variant,$colorPalette:colorPalette,$color:color,children:(0,jsx_runtime.jsx)(Text.A,{disableColor:!0,variant:"paragraph",children})}):children;return(0,jsx_runtime.jsxs)(StyledCollapsibleCtr,{$variant:variant,$colorPalette:colorPalette,$color:color,$width:width,$open:_isOpen,style,className,"data-testid":dataTestId,...props,children:[(0,jsx_runtime.jsxs)(StyledCollapsibleTitle,{$variant:variant,$colorPalette:colorPalette,$color:color,onClick:()=>{setIsOpen((prev=>!prev)),onToggle&&onToggle(!_isOpen)},"data-testid":dataTestIdTitle,children:["string"==typeof title?(0,jsx_runtime.jsx)(Text.A,{disableColor:!0,variant:"paragraph",children:title}):title,(0,jsx_runtime.jsx)(StyledIcon,{children:_isOpen?(0,jsx_runtime.jsx)(IconChevronUp.A,{}):(0,jsx_runtime.jsx)(IconChevronDown.A,{})})]}),_isOpen&&_ChildrenEle]})},StyledCollapsibleCtr=styled_components_browser_esm.Ay.div`
  display: flex;
  flex-direction: column;
  width: ${props=>props.$width};
  border-radius: 1rem;
  ${props=>variantStylesHandler(props.$variant,props.$colorPalette,props.$color,props.$open).container}
...
//# sourceMappingURL=stories-components-Collapsible-Collapsible-stories.80d6d3c9.iframe.bundle.js.map