...
`,NavigationBar=_ref=>{let{children,className,style,color=_tokens_colors_json__WEBPACK_IMPORTED_MODULE_3__.A.zB.iW,onChange,"data-testid":dataTestId,...props}=_ref;const[selectedIndex,setSelectedIndex]=react__WEBPACK_IMPORTED_MODULE_0__.useState(),theme=(0,_ThemeProvider_ThemeProvider__WEBPACK_IMPORTED_MODULE_1__.DP)().theme,colorPalette=(0,_helpers_helpers__WEBPACK_IMPORTED_MODULE_2__.jh)(theme,color),childrenList=Array.isArray(children)?children:[children],_handleSelectedIndex=(index,value)=>{index!==selectedIndex&&(setSelectedIndex(index),onChange&&onChange(value))};let index=0;const ChildrenEle=react__WEBPACK_IMPORTED_MODULE_0__.Children.map(childrenList,(child=>react__WEBPACK_IMPORTED_MODULE_0__.isValidElement(child)&&child.type?"NavigationBarItem"===child.type.displayName?(index++,react__WEBPACK_IMPORTED_MODULE_0__.cloneElement(child,{_index:index,...color&&!child.props.color&&{color},selected:selectedIndex?selectedIndex===index:child.props.selected,_getSelectedIndex:_handleSelectedIndex})):"NavigationBarGroup"===child.type.displayName?react__WEBPACK_IMPORTED_MODULE_0__.cloneElement(child,{children:react__WEBPACK_IMPORTED_MODULE_0__.Children.map(child.props.children,(child=>"NavigationBarGroupItem"===child.type.displayName?(index++,react__WEBPACK_IMPORTED_MODULE_0__.cloneElement(child,{_index:index,_getSelectedIndex:_handleSelectedIndex,...color&&!child.props.color&&{color},selected:selectedIndex?selectedIndex===index:child.props.selected})):"NavigationBarHeader"===child.type.displayName?react__WEBPACK_IMPORTED_MODULE_0__.cloneElement(child,{...color&&!child.props.color&&{color}}):child)),...color&&!child.props.color&&{color}}):child:child));return(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(StyledNavigationBarCtr,{$color:color,$colorPalette:colorPalette,className,style,"data-testid":dataTestId,...props,children:(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("nav",{children:ChildrenEle})})};NavigationBar.displayName="NavigationBar";const __WEBPACK_DEFAULT_EXPORT__=NavigationBar;NavigationBar.__docgenInfo={description:"",methods:[],displayName:"NavigationBar",props:{children:{required:!1,tsType:{name:"union",raw:"React.ReactNode | [React.ReactNode]",elements:[{name:"ReactReactNode",raw:"React.ReactNode"},{name:"tuple",raw:"[React.ReactNode]",elements:[{name:"ReactReactNode",raw:"React.ReactNode"}]}]},description:""},color:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"colorTokens.default.primary.main",computed:!0}},style:{required:!1,tsType:{name:"ReactCSSProperties",raw:"React.CSSProperties"},description:""},className:{required:!1,tsType:{name:"string"},description:""},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value?: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""},"data-testid":{required:!1,tsType:{name:"string"},description:""}}}},"./src/components/NavigationBar/NavigationBarGroup/NavigationBarGroup.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>NavigationBarGroup_NavigationBarGroup});var react=__webpack_require__("./node_modules/react/index.js"),Text=__webpack_require__("./src/components/Text/Text.tsx"),styled_components_browser_esm=__webpack_require__("./node_modules/styled-components/dist/styled-components.browser.esm.js"),IconChevronRight=(0,__webpack_require__("./node_modules/@tabler/icons-react/dist/esm/createReactComponent.mjs").A)("outline","chevron-right","IconChevronRight",[["path",{d:"M9 6l6 6l-6 6",key:"svg-0"}]]),ThemeProvider=__webpack_require__("./src/components/ThemeProvider/ThemeProvider.tsx"),helpers=__webpack_require__("./src/helpers/helpers.tsx"),colors=__webpack_require__("./src/tokens/colors.json"),jsx_runtime=__webpack_require__("./node_modules/react/jsx-runtime.js");const NavigationBarGroup=_ref=>{let{leadingIcon,children,title,expanded=!1,className,color=colors.A.zB.iW,onClick,"data-testid":dataTestId,"data-testid-header":dataTestIdHeader}=_ref;const navigationBarGrpItmContnrRef=react.useRef(null),[expand,setExpand]=(0,react.useState)(expanded),theme=(0,ThemeProvider.DP)().theme,colorPalette=(0,helpers.jh)(theme,color),_toggleExpand=e=>{setExpand((expand=>!expand)),onClick&&onClick(e)};return(0,jsx_runtime.jsxs)(StyledNavBarGroup,{className,"data-testid":dataTestId,children:[(0,jsx_runtime.jsxs)(StyledNavBarGroupHeader,{tabIndex:0,$color:color,$colorPalette:colorPalette,onClick:_toggleExpand,onKeyDown:e=>{"Enter"!==e.key&&" "!==e.key||(_toggleExpand(e),onClick&&onClick(e))},"data-testid":dataTestIdHeader,children:[(0,jsx_runtime.jsxs)("span",{children:[leadingIcon&&(0,jsx_runtime.jsx)(StyledNavBarGroupIcon,{$colorPalette:colorPalette,$color:color,children:leadingIcon}),title&&"string"==typeof title?(0,jsx_runtime.jsx)(Text.A,{color,variant:"span",children:title}):title]}),(0,jsx_runtime.jsx)(StyledNavBarGroupIcon,{$colorPalette:colorPalette,$color:color,$expand:expand,children:(0,jsx_runtime.jsx)(IconChevronRight,{})})]}),(0,jsx_runtime.jsx)(StyledNavBarGroupItemContainer,{ref:navigationBarGrpItmContnrRef,$colorPalette:colorPalette,$color:color,$expand:expand,children:react.Children.map(children,((child,index)=>child&&react.cloneElement(child,{tabIndex:expand?0:-1,key:index})))})]})};NavigationBarGroup.displayName="NavigationBarGroup";const NavigationBarGroup_NavigationBarGroup=NavigationBarGroup,StyledNavBarGroup=styled_components_browser_esm.Ay.ul`
  display: flex;
  flex-direction: column;
  gap: 0.15rem;
